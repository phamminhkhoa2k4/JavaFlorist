...
namespace JavaFlorist.Migrations
{
    ...
    [Migration("20240102100005_cart4")]
    partial class cart4
    {
            ...
            modelBuilder.Entity("JavaFlorist.Models.Domain.Order", b =>
                {
                    ...
                    b.Property<int>("DeliveryInfodelivery_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveryInfodelivery_id");
            ...
            modelBuilder.Entity("JavaFlorist.Models.Domain.Order", b =>
                {
                    ...
                    b.HasOne("JavaFlorist.Models.Domain.Delivery_Info", "DeliveryInfo")
                        .WithMany()
                        .HasForeignKey("DeliveryInfodelivery_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
